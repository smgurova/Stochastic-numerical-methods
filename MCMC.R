...
print(mu.crude <- mean(y)) #[1] 0.223
print(sigma.crude <- sd(y)) #[1] 1.189258
print(psi.crude <- 1 / var(y)) #[1] 0.7070463
...
#better levels at which to draw
# the contour lines.
...
cov(mu.sig.gibbs)
#mu       sigma
#mu    0.169810414 0.005249035
#sigma 0.005249035 0.117680556

# Quantiles of the marginal posterior distributions:
apply(mu.sig.gibbs, 2, quantile, probs = c(0.025, 0.25, 0.5, 0.75, 0.975))
#           mu     sigma
#2.5%  -0.5948640 0.8364844
#25%   -0.0680355 1.0631621
#50%    0.2243340 1.2231303
#75%    0.4828241 1.4485387
#97.5%  0.9993342 2.1922095
...
r.postmode$par #[1]  0.2228948 -0.2412994
...
print(r.V)
  ...
  #          mu       lambda
#mu     1.272902e-01 2.103061e-05
#lambda 2.103061e-05 2.000001e-01
...
print(r.postmode$par) #[1]  0.2228948 -0.2412994
apply(sim.mh, 2, mean)
#mu     lambda 
#0.2593369 -0.4464880 
print(r.V)
...
cov(sim.mh)
 #           mu      lambda
#mu      0.16982381 -0.02375242
#lambda -0.02375242  0.25114020
